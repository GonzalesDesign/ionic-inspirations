...
export class ConceptService {
	...
	public fGetIdea(id: string): Observable<Concept> {
		console.log('this.conceptCollection: ',this.conceptCollection.doc<Concept>(id));
		return this.conceptCollection
			...
			.pipe(
				...
				map(concept => {
					...
					console.log('db-count: concept.socialLike: ', concept.socialLike)
					return concept;
				})
			);
	}
	...
	// public fGetSingleDoc() {
	// 	let docRef = this.conceptCollection().doc("SF");
	// }
	...
	public fUpdateIdea(concept: Concept): Promise<void> {
		...
		return this.conceptCollection.doc(concept.id).update({
			...
			avatarDescription: concept.avatarDescription,
